...
nsys profile -t cuda --stats=true ./aligner --protein --sequence ../data/subset_wol2_protein_10000.faa --maxPairs $MAX_PAIRS --batchSize $BATCH_SIZE --numThreads 8 --output ../data/protein_alignment.fa
